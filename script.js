window.addEventListener('load', function(){
    ...
    class Shield {
        ...
        draw(context){
            context.drawImage(this.image, this.frameX * this.width, 
                0, this.width, this.height, this.game.player.x, this.game.player.y,
    ...
    class UI {
        ...
        draw(context){
            // context.save() help to snapshot all elements in canvas
            context.save();
            ...
            // context.restore() help to restore snapshot 
            context.restore();  
        }
    }
    ...
    class Game {
        ...
        addEnemy(){
            ...
            else if (randomize < 0.5) this.enemies.push(new Stalker(this));
    ...
    function animate(timeStamp){
        ...
        //To Calculate FPS(Frame per Second) = 1000 MS (1 Second) / deltaTime = N FPS
        lastTime = timeStamp;
